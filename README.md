...
* Implement custom validation/business-logic in `src/main/kotlin/businessLogic/`
  * Create classes that implement the `BusinessLogicFunction` interface
  * Return instances of these classes from `getBusinessLogicFunctions()` in `GetBusinessLogicFunctions.kt`
  * Restart the server (`RunServer.kt`)
